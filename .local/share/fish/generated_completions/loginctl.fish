...
complete -c loginctl -s c -d 'Cancel a pending shutdown or reboot'
complete -c loginctl -s i -l ignore-inhibitors -d 'When system shutdown or a sleep state is requested, ignore inhibitor locks'
complete -c loginctl -l dry-run -d 'Just print what would be done'
complete -c loginctl -l no-wall -d 'Do not send wall messages before halt, power-off and reboot'
